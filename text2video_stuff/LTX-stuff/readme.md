==== รวม ไฟล์ ดาวโหลด สำหรับ LTX

รวม workflow LTX <br>
https://huggingface.co/RuneXX/LTX-2.3-Workflows

ltx-2.3-22b-dev-fp8.safetensors <br>
เอาไปไว้ใน <br>
ComfyUI/models/diffusion_models <br>
https://huggingface.co/Lightricks/LTX-2.3-fp8/resolve/main/ltx-2.3-22b-dev-fp8.safetensors


ltx-2.3-spatial-upscaler-x2-1.1.safetensors <br>
เอาไปไว้ใน <br>
ComfyUI/models/latent_upscale_models <br>
