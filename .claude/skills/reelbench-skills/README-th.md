...
| `action-beat-defaults.md` | 3 บั๊กที่เกี่ยวกันจากการเจนครั้งเดียว — beat ท้ายๆที่สั่ง "หันหลังเดิน กล้องยังจับหน้าตัวเอง" กลับเรนเดอร์เป็นช็อต third-person ทั่วไปแทน, คำสั่ง style แบบ "กล้อง camcorder ย้อนยุค" ไม่มีผลต่อภาพเลยทั้งคลิป, และ "จักรยาน" กลายเป็นคนขับมอเตอร์ไซค์สวมหมวกกันน็อค — ทั้งหมดมาจาก beat ที่สั่ง action อย่างเดียวโดยไม่ได้ล็อค shot type/texture/ชนิดวัตถุที่ action นั้นต้องพึ่งพา |
